...
[![Crates.io](https://img.shields.io/badge/crates.io-v1.7.6-blue?logo=rust&style=for-the-badge)](https://crates.io/crates/fory)
...
```kotlin
implementation("org.apache.fory:fory-kotlin:1.7.6")
```
...
```bazel
# MODULE.bazel
bazel_dep(name = "fory", version = "1.7.6")
git_override(module_name = "fory", remote = "https://github.com/apache/fory.git", commit = "v1.7.6")
...
```bash
dotnet add package Apache.Fory --version 1.7.6
```

**Dart**

```bash
dart pub add fory:^1.7.6
...
```gradle
implementation "org.apache.fory:fory-json:1.7.6"
```
