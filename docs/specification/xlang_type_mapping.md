...
| `array<int8>` (int8_array)         | 44           | byte[]                                    | Int8Array / ndarray(int8)                 | Type.int8Array()                      | `int8_t[n]/vector<T>`                               | `[n]int8/[]T`                                  | `Vec<i8>`                         |
...
| `array<float16>` (float16_array)   | 53           | `Float16Array` / `@Float16Type short[]`   | Float16Array / ndarray(float16)           | Type.float16Array()                   | `fory::float16_t[n]/std::vector<fory::float16_t>`   | `[N]float16.Float16` / `[]float16.Float16`     | `Vec<fory::f16>` / `[Float16; N]` |
