...
| bool_array              | 43           | bool[]          | BoolArray / ndarray(np.bool\_)            | /                              | `bool[n]`                                           | `[n]bool/[]T`                                  | `Vec<bool>`                       |
| int8_array              | 44           | byte[]          | Int8Array / ndarray(int8)                 | /                              | `int8_t[n]/vector<T>`                               | `[n]int8/[]T`                                  | `Vec<i8>`                         |
| int16_array             | 45           | short[]         | Int16Array / ndarray(int16)               | /                              | `int16_t[n]/vector<T>`                              | `[n]int16/[]T`                                 | `Vec<i16>`                        |
| int32_array             | 46           | int[]           | Int32Array / ndarray(int32)               | /                              | `int32_t[n]/vector<T>`                              | `[n]int32/[]T`                                 | `Vec<i32>`                        |
| int64_array             | 47           | long[]          | Int64Array / ndarray(int64)               | /                              | `int64_t[n]/vector<T>`                              | `[n]int64/[]T`                                 | `Vec<i64>`                        |
| uint8_array             | 48           | short[]         | UInt8Array / ndarray(uint8)               | /                              | `uint8_t[n]/vector<T>`                              | `[n]uint8/[]T`                                 | `Vec<u8>`                         |
| uint16_array            | 49           | int[]           | UInt16Array / ndarray(uint16)             | /                              | `uint16_t[n]/vector<T>`                             | `[n]uint16/[]T`                                | `Vec<u16>`                        |
| uint32_array            | 50           | long[]          | UInt32Array / ndarray(uint32)             | /                              | `uint32_t[n]/vector<T>`                             | `[n]uint32/[]T`                                | `Vec<u32>`                        |
| uint64_array            | 51           | long[]          | UInt64Array / ndarray(uint64)             | /                              | `uint64_t[n]/vector<T>`                             | `[n]uint64/[]T`                                | `Vec<u64>`                        |
| float8_array            | 52           | /               | /                                         | /                              | /                                                   | /                                              | /                                 |
| float16_array           | 53           | Float16List     | Float16Array / ndarray(float16)           | `number[]`                     | `fory::float16_t[n]/std::vector<fory::float16_t>`   | `[N]float16.Float16` / `[]float16.Float16`     | `Vec<fory::f16>` / `[Float16; N]` |
| bfloat16_array          | 54           | BFloat16List    | BFloat16Array / ndarray(bfloat16)         | `BFloat16Array` / `BFloat16[]` | `fory::bfloat16_t[n]/std::vector<fory::bfloat16_t>` | `[N]bfloat16.BFloat16` / `[]bfloat16.BFloat16` | `Vec<BFloat16>` / `[BFloat16; N]` |
| float32_array           | 55           | float[]         | Float32Array / ndarray(float32)           | /                              | `float[n]/vector<T>`                                | `[n]float32/[]T`                               | `Vec<f32>`                        |
| float64_array           | 56           | double[]        | Float64Array / ndarray(float64)           | /                              | `double[n]/vector<T>`                               | `[n]float64/[]T`                               | `Vec<f64>`                        |
...
- `Float16List` and `BFloat16List` are the Dart xlang `float16_array` and `bfloat16_array` carriers.
