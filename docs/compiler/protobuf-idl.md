...
| gRPC ecosystem     | Native                        | Java/Python/Go/Rust/C#/Kotlin service codegen |

Fory can generate Java, Python, Go, Rust, C#, and Kotlin gRPC service companions
...
```bash
foryc api.proto --java_out=./generated/java --python_out=./generated/python --rust_out=./generated/rust --csharp_out=./generated/csharp --kotlin_out=./generated/kotlin --grpc
```
