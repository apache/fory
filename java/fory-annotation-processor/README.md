...
`@JsonType`. The generated rules retain effective `@JsonValue` and `@JsonRawValue` members and their
runtime annotations. The outputs are generated by javac during the application build.
