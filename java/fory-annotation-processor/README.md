...
companion when required. A non-empty mix-in receives exact platform configuration and a
...
generic endpoints, subtype and unwrapped models, and selected codec constructors. An empty mix-in
...
build-time marker and cannot be added or removed through a mix-in. The processor does not duplicate
