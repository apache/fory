...
`@JsonType`. The generated rules retain effective `@JsonValue`, `@JsonRawValue`, and `@JsonBase64`
members, their runtime annotations, and selected codec constructors. The outputs are generated by
javac during the application build.
