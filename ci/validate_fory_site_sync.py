...
def sync_files(fory_root: pathlib.Path, site_root: pathlib.Path, sync_file: pathlib.Path) -> None:
...
def parse_args() -> argparse.Namespace:
  parser = argparse.ArgumentParser(description="Sync docs to fory-site and validate build.")
