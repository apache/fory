...
The tests consume `org.apache.fory:fory-core:1.6.1`,
`org.apache.fory:fory-json:1.6.1`, and
`org.apache.fory:fory-annotation-processor:1.6.1` from the local Maven
