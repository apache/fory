...
The tests consume `org.apache.fory:fory-core:1.5.0`,
`org.apache.fory:fory-json:1.5.0`, and
`org.apache.fory:fory-annotation-processor:1.5.0` from the local Maven
